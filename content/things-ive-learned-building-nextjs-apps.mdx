...
- I ported over my personal site from [Hugo](/blog/migrating-to-hugo) to [Next.js + MDX](https://github.com/imwalshey/leerob.io).
...
My [portfolio](https://github.com/imwalshey/leerob.io) has transformed quite a bit since I started it in 2014. Originally, it was
